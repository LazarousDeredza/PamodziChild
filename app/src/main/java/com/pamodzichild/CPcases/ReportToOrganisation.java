...
public class ReportToOrganisation extends Fragment {
    ...
    ReportToOrganisationsAdapter myOrganisationsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_report_to_organisation, container, false);
        ...
        myOrganisationsAdapter = new ReportToOrganisationsAdapter(myCPOrganisationsList, getContext());
        ...
        myCPOrganisationsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChildren()) {
                    ...
                    txtLoading.setText("There are no Organisations added yet");
